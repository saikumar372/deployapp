...
function AdminEventListingComponent_tr_26_Template(rf, ctx) { if (rf & 1) {
...
AdminEventListingComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AdminEventListingComponent, selectors: [["app-admin-event-listing"]], decls: 27, vars: 1, consts: [[1, "row"], [1, "col-md-12"], [1, "card"], [1, "card-header"], [1, "card-title", "left-title"], [1, "text-center", "right-add-event"], ["routerLink", "/admin/add-event", 1, "btn", "btn-success", "mr-1"], [1, "card-body"], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], [3, "routerLink"]], template: function AdminEventListingComponent_Template(rf, ctx) { if (rf & 1) {
